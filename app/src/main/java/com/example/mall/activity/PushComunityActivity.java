...
public class PushComunityActivity extends AppCompatActivity {
               ...
               // comunity.setUserOnlyId(user.getObjectId());
                ...
                comunity.save(new SaveListener<String>() {
                    ...
                    public void done(String s, BmobException e) {
                        if (e==null){
                            Toast.makeText(PushComunityActivity.this, "创建成功", Toast.LENGTH_SHORT).show();
                            finish();
                        }else {
                            Toast.makeText(PushComunityActivity.this, "创建失败"+e, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
