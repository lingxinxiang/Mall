...
import com.example.mall.Adapter.MyComunityAdapter;
...
public class MyComunityActivit extends AppCompatActivity {
            ...
            public void done(List<Comunity> list, BmobException e) {
                ...
                if (e==null){
                    ...
                    if (data.size()>0){
                        ...
                        myComunityAdapter = new MyComunityAdapter(MyComunityActivit.this,data);
                        mycomrv.setLayoutManager(new LinearLayoutManager(MyComunityActivit.this));
                    ...
                    Toast.makeText(MyComunityActivit.this, "加载失败"+e, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    SwipeMenuCreator swipeMenuCreator = new SwipeMenuCreator() {
        ...
        public void onCreateMenu(SwipeMenu swipeLeftMenu, SwipeMenu swipeRightMenu, int viewType) {
            ...
            SwipeMenuItem deleteItem = new SwipeMenuItem(MyComunityActivit.this)
                ...
                comunity.delete(new UpdateListener() {
                    ...
                    public void done(BmobException e) {
                        if (e==null){
                            ...
                            Toast.makeText(MyComunityActivit.this, "删除失败", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
